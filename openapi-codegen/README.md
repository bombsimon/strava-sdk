# Rust API client for strava-sdk
...
Put the package under your project folder in a directory named `strava-sdk` and add the following to `Cargo.toml` under `[dependencies]`:

```
strava-sdk = { path = "./strava-sdk" }
```
